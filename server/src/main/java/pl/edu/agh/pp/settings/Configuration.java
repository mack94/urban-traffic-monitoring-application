...
public class Configuration {
    ...
    protected synchronized void initialize() throws BackingStoreException, IOException {
        if (!preferences.getBoolean("UTMAServerInitialized", false)) {
            resetPreferences();
            preferences.putBoolean("UTMAServerInitialized", true);
            logger.info("First UTMA server INITIALIZATION! Preferences have been set up");
        }
    }
